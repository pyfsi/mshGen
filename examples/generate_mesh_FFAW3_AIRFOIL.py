'''
generate_mesh_FFAW3_AIRFOIL.py
author: Thomas Haas
updated: 23.08.2024
...
airfoil_name = "FFA_W3_211"

# Airfoil file (Add airfoil file to './airfoils/' directory)
filename1 = path + "/airfoils/FFA_W3_211.txt"
...
# Mesh parameters:
mesh_scale = 10         # Extents of C-grid
mesh_level = "MEDIUM"   # Mesh refinement level (Choose from "COARSE", "FINE")
slice_locations = [0., 1.]
layer_resolution = [1]
layer_grading = [1.]
layer_aileron = None
